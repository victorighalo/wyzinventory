                ...
                <div class="clearfix">
                    ...
                    <div class="float-right">
                        ...
                        <div class="fluid-container">
                            <h3 class="card-title font-weight-bold text-right mb-0">{{$products}}</h3>
                        </div>
                    </div>
                </div>
        ...
        <div class="card card-statistics">
            <div class="card-body">
                <div class="clearfix">
                    ...
                    <div class="float-right">
                        <p class="card-text text-right">Store keepers</p>
                        <div class="fluid-container">
                            <h3 class="card-title font-weight-bold text-right mb-0">{{$storekeepers}}</h3>
                        </div>
                    </div>
                </div>
                <p class="text-muted mt-3">
