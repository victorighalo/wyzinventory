<nav class="sidebar sidebar-offcanvas" id="sidebar">
    ...
    <ul class="nav">
        ...
        @if(Auth::user()->hasRole('admin'))
            ...
            <li class="nav-item"><a class="nav-link" href="{{url('auditors')}}">
                    <img class="menu-icon" src="{{asset('images/menu_icons/01.png')}}" alt="menu icon"><span class="menu-title">Auditors</span></a>
            </li>
        @endif
