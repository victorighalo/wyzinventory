        ...
        <div class="content-wrapper">
            ...
            <div class="row justify-content-center flex-grow mb-5 mt-5">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Auditors form
                            ...
                            <p class="card-description">
                                Fill the form below to create an Auditor
                            </p>
                                ...
                                <form id="create_super_agent">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <input type="phone" id="phone" class="form-control" name="phone" value="" required>
                                            @if ($errors->has('phone'))
                                                <span class="invalid-feedback" role="alert">
            ...
            <div class="row">
                <div class="col-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title mb-4">Auditors</h5>
